...
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/N_MIXER_PIPE_STAGES
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/HPOS_WIDTH
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/VPOS_WIDTH
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_DISPLAY
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_FRONT
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_SYNC
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_BACK
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_DISPLAY
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_BOTTOM
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_SYNC
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_TOP
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_SYNC_START
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_SYNC_END
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/H_MAX
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_SYNC_START
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_SYNC_END
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/V_MAX
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/clk
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/reset
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/enable
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/hsync
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/vsync
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/display_on
add wave -noupdate -expand -group VGA -radix unsigned /MEM_BRUSH_TestBench/i_vga/hpos
add wave -noupdate -expand -group VGA -radix unsigned /MEM_BRUSH_TestBench/i_vga/vpos
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/d_hpos
add wave -noupdate -expand -group VGA /MEM_BRUSH_TestBench/i_vga/d_vpos
...
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/SLOWNESS
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/RESOLUTION_H
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/RESOLUTION_V
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/VPOS_WIDTH
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/HPOS_WIDTH
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/BRUSH_COLOR
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/BRUSH_BASE_SIZE
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/BRUSH_MAX_SIZE
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/INIT_XPOS
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/INIT_YPOS
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/SIZE_WIDTH
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/clk
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/reset
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/BTN
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/BTN_POSEDGE
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/display_on
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/fifofull
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/hpos
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/vpos
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/FB_RGB
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/memenable
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/rgb
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/writergb
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/fifopush
add wave -noupdate -group BRUSH -radix unsigned /MEM_BRUSH_TestBench/Painting_Brush/writecounter_x
add wave -noupdate -group BRUSH -radix unsigned /MEM_BRUSH_TestBench/Painting_Brush/writecounter_y
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/writestate
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/brush_size
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/cursor_xpos
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/cursor_ypos
add wave -noupdate -group BRUSH /MEM_BRUSH_TestBench/Painting_Brush/counterclk
...
add wave -noupdate -expand -group MEM -expand -group G_BLOCK /MEM_BRUSH_TestBench/FrameBuffer/G_MEMORY/ramblock
add wave -noupdate -expand -group MEM -expand -group G_BLOCK /MEM_BRUSH_TestBench/FrameBuffer/G_MEMORY/addr_x
add wave -noupdate -expand -group MEM -expand -group G_BLOCK /MEM_BRUSH_TestBench/FrameBuffer/G_MEMORY/data_x
...
WaveRestoreCursors {{Cursor 1} {25185 ns} 0}
...
update
WaveRestoreZoom {25028 ns} {28192 ns}
